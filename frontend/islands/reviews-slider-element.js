export default class ReviewsSliderElement extends HTMLElement {
  constructor() {
    super()
  ...
  connectedCallback() {
    ...
    if (this.swiperEl.swiper) this.handleInit()
    else this.swiperEl.addEventListener('swiperinit', this.handleInit, { once: true })
  }
...
if (!window.customElements.get('reviews-slider-element')) {
  window.customElements.define('reviews-slider-element', ReviewsSliderElement)
}
